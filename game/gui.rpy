...
define gui.accent_color = '#02449f'
...
define gui.choice_button_text_idle_color = '#d7d7d7'
define gui.choice_button_text_hover_color = "#ffffff"
define gui.choice_button_text_insensitive_color = '#e2e2e27f'
